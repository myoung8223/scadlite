...
Prism.languages.scad={comment:[{pattern:/(^|[^\\])\/\*[\s\S]*?(?:\*\/|$)/,lookbehind:!0,greedy:!0},{pattern:/(^|[^\\:])\/\/.*/,lookbehind:!0,greedy:!0}],string:{pattern:/"(?:\\[\s\S]|[^\\\r\n"])*"/,greedy:!0},keyword:/\b(?:function|module|include|use|if|else|for|intersection_for|assign)\b/,builtin:/\b(?:cube|sphere|cylinder|polyhedron|square|circle|polygon|scale|rotate|translate|mirror|multmatrix|color|minkowski|hull|render|union|difference|intersection|linear_extrude|rotate_extrude|surface|projection|render|children|echo|str|search|version|version_num)\b/,number:/\b\d+(?:\.\d+)?\b/,operator:/[=+\-*/%!<>]=?|&&|\|\||:/,punctuation:/[{}[\];(),.]/};
